...
public class Adapter extends SelectableAdapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.meal_star.setImageResource(currentMeal.getFavoriteIcon());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        private ImageView meal_star;
        private TextView meal_star_check;
        ...
        public ViewHolder(View itemView, ClickListener listener) {
            ...
            meal_star = (ImageView) itemView.findViewById(R.id.meal_star);
            meal_star_check = (TextView) itemView.findViewById(R.id.meal_star_check);
            ...
            meal_star.setOnClickListener(mealStarOnClickListener);
            meal_contents.setOnClickListener(mealContentsOnClickListener);
        ...
        View.OnClickListener mealStarOnClickListener = new View.OnClickListener() {
            public void onClick(View v) {

            }
        };

        View.OnClickListener mealContentsOnClickListener = new View.OnClickListener() {
            public void onClick(View v) {
                /*final AlertDialog.Builder contentsAlert = new AlertDialog.Builder(get);
