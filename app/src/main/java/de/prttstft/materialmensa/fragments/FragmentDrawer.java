...
public class FragmentDrawer extends android.support.v4.app.Fragment {
    ...
    public List<Drawer> getData() {
        ...
        int[] icons = {R.drawable.ic_ndrawer_icon1, R.drawable.ic_ndrawer_icon2, R.drawable.ic_cafete, R.drawable.ic_grillcafe, R.drawable.ic_campusdoener, R.drawable.ic_onewaysnack, R.drawable.ic_mensula};
